...
QT_MOC_LITERAL(3, 18, 18), // "QList<QStringList>"
QT_MOC_LITERAL(4, 37, 15), // "onBtnAddClicked"
QT_MOC_LITERAL(5, 53, 15), // "onBtnDelClicked"
QT_MOC_LITERAL(6, 69, 17) // "onBtnApplyClicked"

    },
    "Setting\0sendData\0\0QList<QStringList>\0"
    "onBtnAddClicked\0onBtnDelClicked\0"
    "onBtnApplyClicked"
};
...
void Setting::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendData((*reinterpret_cast< QList<QStringList>(*)>(_a[1]))); break;
        case 1: _t->onBtnAddClicked(); break;
        case 2: _t->onBtnDelClicked(); break;
        ...
        {
            typedef void (Setting::*_t)(QList<QStringList> );
...
// SIGNAL 0
void Setting::sendData(QList<QStringList> _t1)
{
